...
## DSH adaptation note (vendored; everything above is unmodified)

Vendored verbatim from NousResearch/hermes-agent skills/research/arxiv (MIT,
...
Everything else — arXiv Atom API, Semantic Scholar citations/references/recommendations,
BibTeX generation, version pinning, withdrawn-paper checks — works unchanged from the
pinned uv compute lane via bash.
